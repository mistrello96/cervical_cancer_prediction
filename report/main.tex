...
\todo[inline]{Dovremmo specificare da qualche parte la versione di knime per la riproduzione? e dire che gli snippet python sono solo per la rappresentazione? Magari metterla come frase appena diciamo che operazioni di preprocessing facciamo. DP}
\end{abstract}
