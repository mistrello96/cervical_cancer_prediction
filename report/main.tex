...
Il confronto tra i vari modelli è stato effettuato sfruttando dei \textit{paired} t-test, prima tra i due modelli appartenenti al medesimo input e poi tra i migliori di ogni strategia.
